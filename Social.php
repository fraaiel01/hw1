...
<html>
   <head>
     ...
     <link rel="stylesheet" href="css/SocialCSS.css"/>
     <link href="https://fonts.googleapis.com/css2?family=Poppins:wght@200&display=swap" rel="stylesheet">
     <script  src="script/like.js" defer="true"></script>
   </head>
...
<header>
  <nav id="navigazione">
             <div id="titolo">SOCIAIEL</div>
              <div class="elementi">
                  <a id="home" href="home_1.php" data-id_user=<?php echo $_SESSION["identificativo"]?>>Home</a>
                  <a id="logout" href="logout_1.php">Logout</a>
                  <a id="social" href="AreaPersonale_1.php">Area Post</a>
              </div>
  </nav>
</header>
